...
execute store result entity @s Motion[0] double 0.010 run scoreboard players operation @s projectile_motion_x2 -= @s projectile_motion_x1
execute store result entity @s Motion[1] double 0.010 run scoreboard players operation @s projectile_motion_y2 -= @s projectile_motion_y1
execute store result entity @s Motion[2] double 0.010 run scoreboard players operation @s projectile_motion_z2 -= @s projectile_motion_z1
